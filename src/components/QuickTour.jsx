...
export const TOUR_STEPS = [
  { menu: '대시보드', target: 'today', title: '① 월요일 아침 1분 — 오늘 피드', body: '맨 위 [오늘 활동]은 지금 누가 나무와 이야기하고 있는지 실시간으로, 그 아래는 오늘 챙길 학생·아침 활동 카드·알림장 한 줄, [이번 주 브리핑]은 지난 7일에 바뀐 것과 이번 주 할 일 3가지(복사해서 동학년 협의·학급 일지에). 매일 아침 여기만 보면 됩니다.' },
  ...
  { menu: '가정 연계', target: 'page', title: '⑦ 가정 연계 — 보내는 시점은 선생님이', body: '맨 위 [학부모 상담 준비 카드]는 상담 주간에 학생 1명당 30초 — 강점 먼저, 우리 아이 숫자만, 다른 학생 이름·대화 인용·판정어 없음. 그 아래 가정통신문 6종, 학부모 대화 카드, 학급 리포트 발행 → 문자 문구 복사 → "집에서 해봤어요" 익명 회신.' },
